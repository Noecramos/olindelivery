  ...
  return (
    <div style={{ background: "#F2F4F8", minHeight: "100vh" }}>
      <main className="mobile-container relative bg-white pb-20">
        {/* Top Bar */}
        <div
          className="pt-8 px-6 pb-6 flex justify-center items-center sticky top-0 z-40 bg-opacity-95 backdrop-blur-md transition-all duration-300 shadow-lg rounded-b-3xl bg-center bg-cover bg-no-repeat"
          style={{
